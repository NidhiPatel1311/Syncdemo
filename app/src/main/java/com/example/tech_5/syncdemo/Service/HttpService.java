package com.example.tech_5.syncdemo.Service;
...
import com.example.tech_5.syncdemo.Main2Activity;
...
public class HttpService extends IntentService {
    ...
    private void verifyOtp(final String otp) {
        StringRequest strReq = new StringRequest(Request.Method.POST,
                Config1.URL_VERIFY_OTP, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Intent intent = new Intent(HttpService.this, Main2Activity.class);
