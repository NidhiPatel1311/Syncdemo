...
import com.example.tech_5.syncdemo.Adapter.ContactsAdapter;
import com.example.tech_5.syncdemo.Model.Contact;

import java.util.List;

public class SearchFilterActivity extends AppCompatActivity implements ContactsAdapter.ContactsAdapterListener {
    ...
    private static final String URL = "https://purposeofliving.000webhostapp.com/ionic/view.php";
    ...
    public void onContactSelected(Contact contact) {
        Toast.makeText(getApplicationContext(), "Selected: " + contact.getName() + " " +contact.getMname() + ""+ contact.getLname()+","+ contact.getMobileno(), Toast.LENGTH_LONG).show();
    }
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(SearchFilterActivity.this, LoginActivity.class);
