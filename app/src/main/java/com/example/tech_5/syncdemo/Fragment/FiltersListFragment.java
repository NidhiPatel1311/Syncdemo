...
import com.example.tech_5.syncdemo.Adapter.ThumbnailsAdapter;
import com.example.tech_5.syncdemo.FilterimgActivity;
...
import com.example.tech_5.syncdemo.Util.SpacesItemDecoration;
    ...
    public void prepareThumbnail(final Bitmap bitmap) {
        Runnable r = new Runnable() {
            public void run() {
                ...
                if (bitmap == null) {
                    thumbImage = BitmapUtils.getBitmapFromAssets(getActivity(), FilterimgActivity.IMAGE_NAME, 100, 100);
                } else {
